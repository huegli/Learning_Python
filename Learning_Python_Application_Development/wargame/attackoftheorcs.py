...
from hut import Hut
from huterror import HutNumberGreaterThanFiveError, NegativeHutNumberError, HutError
    ...
    def _process_user_choice(self):
        ...
        while verifying_choice:
            ...
            try:
                idx = int(user_choice)
                if idx < 1:
                    raise NegativeHutNumberError
                elif idx > 5:
                    raise HutNumberGreaterThanFiveError
